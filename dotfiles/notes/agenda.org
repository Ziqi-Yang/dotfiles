...
*** TODO after some weeks send gc-statics data and change emacs-gc-stats-gc-defaults
DEADLINE: <2023-06-20 Tue>
...
*** PROJ rust libarary read pass
DEADLINE: <2023-06-19 Mon>
read pass from env, file or use external command (like gpg) to help read secret.
